const services = [
  {
    photo: "./images/servicos/contratos_manutencao.svg",
    ...
    content: [
      {
        ...
        photo: "./images/servicos/gestao_manutencao.svg",
        acting: [
          {
      ...
      },
      {
        ...
        photo: "./images/servicos/inspecoes.svg",
      },
      {
        tab: "Limpeza Técnica",
        ...
        photo: "./images/servicos/limpeza_tecnica.svg",
      },
      {
        ...
        photo: "./images/servicos/manutencao_equipamentos.svg",
      },
    ],
  },
  {
    photo: "./images/servicos/servicos_oficina.svg",
  ...
  {
    photo: "./images/servicos/servicos_campo.svg",
    title: "Serviços de Campo",
    content: [
      {
        tab: "Manutenção Preventiva",
        title: "Manutenção Preventiva",
        photo: "./images/servicos/manutencao_preventiva.svg",
        subTitle:
      ...
      },
      {
        ...
        photo: "./images/servicos/manutencao_corretiva.svg",
        subTitle:
      ...
      },
      {
        ...
        photo: "./images/servicos/teste_epi.svg",
        subTitle:
  ...
  {
    photo: "./images/servicos/construcao_montagem_substacao.svg",
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        photo: "./images/servicos/retrofit_campo.svg",
        subTitle:
  ...
  {
    photo: "./images/servicos/transformadores.svg",
  ...
  {
    photo: "./images/servicos/manutencao_preditiva.svg",
    title: "Manutenção Preditiva",
    content: [
      {
        tab: "Inspeção por Ultrassom",
        title: "Inspeção por Ultrassom",
        photo: "./images/servicos/ultrassom.svg",
        subTitle:
      ...
      },
      {
        ...
        photo: "./images/servicos/termografia.svg",
        subTitle:
      ...
      },
      {
        ...
        photo: "./images/servicos/analise_de_oleo.svg",
        subTitle:
  ...
  {
    photo: "./images/servicos/laudos_estudos.svg",
    title: "Laudos e Estudos",
    content: [
      {
        tab: "Análise de Rede",
        title: "Análise de Rede",
        photo: "./images/servicos/analise_rede.svg",
        subTitle:
      ...
      },
      {
        ...
        photo: "./images/servicos/circuito_seletividade.svg",
        subTitle:
      ...
      },
      {
        tab: "SPDA",
        title: "SPDA",
        photo: "./images/servicos/spda.svg",
        subTitle:
      ...
      },
      {
        tab: "NR10",
        title: "NR10",
        photo: "./images/servicos/nr_10.svg",
        subTitle:
  ...
  {
    photo: "./images/servicos/ensaios_especiais.svg",
    title: "Ensaios Especiais",
    content: [
      {
        tab: "Torkel",
        title: "Torkel",
        photo: "./images/servicos/torkel.svg",
        subTitle:
      ...
      },
      {
        tab: "CT Analyzer",
        title: "CT Analyzer",
        photo: "./images/servicos/ct_analayzer.svg",
        subTitle:
      ...
      },
      {
        tab: "Franeo",
        title: "Franeo",
        photo: "./images/servicos/franeo.svg",
        subTitle:
      ...
      },
      {
        tab: "Vidar",
        title: "Vidar",
        photo: "./images/servicos/vidar.svg",
        subTitle:
...
const servicesContent = services.map((service, index) => ({
  ...
  content: service.content.map((item, itemIndex) => ({
    ...item,
    id: `service-${index}-item-${itemIndex}`,
    acting: item.acting
      ? item.acting.map((actor, actorIndex) => ({
          ...actor,
          id: `service-${index}-item-${itemIndex}-actor-${actorIndex}`,
        }))
      : [],
  })),
}));
