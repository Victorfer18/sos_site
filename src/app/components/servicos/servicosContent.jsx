const servicos = [
    ...
    content: [
      {
        ...
        photo: "./images/servicos/gestao_manutencao.jpg",
        acting: [
          {
      ...
      },
      {
        ...
        photo: "./images/servicos/inspecoes.jpg",
      },
      {
        tab: "Limpeza Técnica",
        ...
        photo: "./images/servicos/limpeza_tecnica.jpg",
      },
      {
        ...
        photo: "./images/servicos/manutencao_equipamentos.jpg",
      },
    ],
  },
  {
    photo: "./images/servicos/servicos_oficina.jpg",
  ...
  {
    photo: "./images/servicos/servicos_campo.jpg",
    title: "Serviços de Campo",
    content: [
      {
        tab: "Manutenção Preventiva",
        title: "Manutenção Preventiva",
        photo: "./images/servicos/manutencao_preventiva.jpg",
        subTitle:
      ...
      },
      {
        ...
        photo: "./images/servicos/manutencao_corretiva.jpg",
        subTitle:
      ...
      },
      {
        ...
        photo: "./images/servicos/teste_epi.jpg",
        subTitle:
  ...
  {
    photo: "./images/servicos/construcao_montagem_substacao.jpg",
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        photo: "./images/servicos/retrofit_campo.jpg",
        subTitle:
  ...
  {
    photo: "./images/servicos/transformadores.jpg",
  ...
  {
    photo: "./images/servicos/manutencao_preditiva.jpg",
    title: "Manutenção Preditiva",
    content: [
      {
        tab: "Inspeção por Ultrassom",
        title: "Inspeção por Ultrassom",
        photo: "./images/servicos/ultrassom.jpg",
        subTitle:
      ...
      },
      {
        ...
        photo: "./images/servicos/termografia.jpg",
        subTitle:
      ...
      },
      {
        ...
        photo: "./images/servicos/analise_de_oleo.jpg",
        subTitle:
  ...
  {
    photo: "./images/servicos/laudos_estudos.jpg",
    title: "Laudos e Estudos",
    content: [
      {
        tab: "Análise de Rede",
        title: "Análise de Rede",
        photo: "./images/servicos/analise_rede.jpg",
        subTitle:
      ...
      },
      {
        ...
        photo: "./images/servicos/circuito_seletividade.jpg",
        subTitle:
      ...
      },
      {
        tab: "SPDA",
        title: "SPDA",
        photo: "./images/servicos/spda.jpg",
        subTitle:
      ...
      },
      {
        tab: "NR10",
        title: "NR10",
        photo: "./images/servicos/nr_10.jpg",
        subTitle:
  ...
  {
    photo: "./images/servicos/ensaios_especiais.jpg",
    title: "Ensaios Especiais",
    content: [
      {
        tab: "Torkel",
        title: "Torkel",
        photo: "./images/servicos/torkel.jpg",
        subTitle:
      ...
      },
      {
        tab: "CT Analyzer",
        title: "CT Analyzer",
        photo: "./images/servicos/ct_analayzer.jpg",
        subTitle:
      ...
      },
      {
        tab: "Franeo",
        title: "Franeo",
        photo: "./images/servicos/franeo.jpg",
        subTitle:
      ...
      },
      {
        tab: "Vidar",
        title: "Vidar",
        photo: "./images/servicos/vidar.jpg",
        subTitle:
